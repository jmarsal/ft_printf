...
clang -Wall -Wextra -Werror test/srcs/ft_test_conversion_d_i.c -o ft_t_conv_d_i -I./libft/includes libft/libft.a -I./includes libftprintf.a
...
clang -Wall -Wextra -Werror test/srcs/ft_test_conversion_D.c -o ft_t_conv_D -I./libft/includes libft/libft.a -I./includes libftprintf.a
...
clang -Wall -Wextra -Werror test/srcs/ft_test_conversion_o.c -o ft_t_conv_o -I./libft/includes libft/libft.a -I./includes libftprintf.a
...
clang -Wall -Wextra -Werror test/srcs/ft_test_conversion_u.c -o ft_t_conv_u -I./libft/includes libft/libft.a -I./includes libftprintf.a
...
clang -Wall -Wextra -Werror test/srcs/ft_test_conversion_x_X.c -o ft_t_conv_x_X -I./libft/includes libft/libft.a -I./includes libftprintf.a
...
clang -Wall -Wextra -Werror test/srcs/ft_test_conversion_c.c -o ft_t_conv_c -I./libft/includes libft/libft.a -I./includes libftprintf.a
